...
//	private String optType = " ";
	...
	public void setIntrumentType(String intrumentType) {
...
//				+ ", " + ordNo + ", " + brnCd + ", " + usrId + ", " + proCli + ", " + cliActNo + ", " + cpCd + ", "
//				+ remarks + ", " + actTyp + ", " + TCd + ", " + ordTm + ", " + mktTyp + ", " + aucNo + ", " + stpTyp
//				+ ", " + oppBrokerCd + ", " + trdTrigPrc + ", " + ctclId + ", " + ordInst + ", " + secIdentifier + ", "
//				+ sym + ", " + ser + ", " + inst + ", " + expDt + ", " + strPrc + ", " + optType + ", " + fill1 + ", "
//				+ fill2 + ", " + fill3 + ", " + fill4 + ", " + fill5 + ", " + fill6 + ", " + fill7 + ", " + fill8;
		
		return seqNo + "," + mkt + "," + trdNo + ", " + trdTm + "," + tkn + ", " + trdQty + "," + trdPrc + ", " + bsFlg
				+ ", " + ordNo + ", " + brnCd + ", " + usrId + ", " + proCli + ", " + cliActNo + ", " + cpCd + ", "
				+ remarks + ", " + actTyp + ", " + TCd + ", " + ordTm + ", " + mktTyp + ", " + aucNo + ", " + stpTyp
				+ ", " + oppBrokerCd + ", " + trdTrigPrc + ", " + ctclId + ", " + ordInst + ", " + secIdentifier + ", "
				+ sym + ", " + ser + ", " + secName + ", " + intrumentType + /*", " + inst + ", " + expDt + ", " + strPrc + ", " + optType +*/ ", " + fill1 + ", "
				+ fill2 + ", " + fill3 + ", " + fill4 + ", " + fill5 + ", " + fill6 + ", " + fill7 + ", " + fill8;
	}

	/*
	 * public String toString() { String k =null; k= this.trdNo+",\t"+ "null"+",\t"+
	 * this.sym+",\t"+ this.ser+",\t"+ "null"+",\t"+ this.inst+",\t"+
	 * this.mktTyp+",\t"+ this.mkt+",\t"+ this.usrId+",\t"+ this.brnCd+",\t"+
	 * this.bsFlg+",\t"+ this.trdQty+",\t"+ this.trdPrc+",\t"+ this.proCli+",\t"+
	 * this.cliActNo+",\t"+ "null"+",\t"+ "null"+",\t"+ this.aucNo+",\t"+
	 * "null"+",\t"+ this.trdTm+",\t"+ "null"+",\t"+ this.ordNo+",\t"+ " ";
	 * 
	 * return k; }
	 */
