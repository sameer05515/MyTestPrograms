...
private void method4(JspWriter out,List<HashMap<String, String>> list,XMLUtilityImpl xmlUtilityImpl) throws Exception{
				...
				if (mapObject.keySet() != null && mapObject.keySet().size() > 0) {
					...
					//out.println("<tr>");
					//out.println("<td>");
					//out.println(Word.node.getName() + ":" );
					out.println("<h3>" );
					// out.println("<h1>");
					 
					 out.println((++allCount)+" : "+ mapValueForKey );
					 //out.println("</h1>");
					//out.println("</td>");
					...
					//out.println("<td>");
					//out.println(Word.TYPE.getName() + ":" );
					//out.println("<h1>" );
					out.println("( "+ mapValueForKey + " )");
					//out.println("</h1>");
					//out.println("</td></tr>");
