...
@XmlRootElement(name = "executeWithWsChannelResponse", namespace = "http://service.core.iagent.ist.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "executeWithWsChannelResponse", namespace = "http://service.core.iagent.ist.com/")
public class ExecuteWithWsChannelResponse {
