...
public class FileSearcher {
	...
	/* public static void main(String[] args) {
		String res = new FileSearcher()
				.startSearch("C:/Users/796412/Desktop/readings/",allowedExtentions);
		...
		for (File child : children) {
			...
			if (child.isFile()) {
				...
				fileList.add("{\"name\":\"" + child.getName()
						+ "\" , \"filePath\":\"http://127.0.0.1:8888/carousel-with-angularjs/my.jsp?documentId="
